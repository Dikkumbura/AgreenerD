        ...
        <div className="mb-16">
          <div className="bg-brand-lime/10 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-gray-700 mb-8">
              Enjoy pick-up and delivery service across Julington Creek Plantation, with reliable turnaround 
              times and expert garment care.
            </p>
            
            <div>
              <h3 className="font-semibold text-lg text-brand-navy mb-4">
                Proudly Serving Julington Creek Plantation and Surrounding Areas Including:
              </h3>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                {julingtonAreas.map((area, index) => (
                  <div key={index} className="bg-white rounded-lg p-3 text-sm text-gray-700 text-center">
                    {area}
                  </div>
                ))}
              </div>
