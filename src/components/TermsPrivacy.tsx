...
const TermsPrivacy: React.FC = () => {
  return (
    <>
      <SEOHead 
        title="Terms of Use & Privacy Policy | A Greener Cleaner"
        description="Read the Terms of Use and Privacy Policy for A Greener Cleaner, Jacksonville's eco-friendly dry cleaning service."
        keywords="terms of use, privacy policy, dry cleaning terms, Jacksonville, A Greener Cleaner"
        canonicalUrl="https://www.agreenerdrycleaner.com/t/tou-and-privacy"
